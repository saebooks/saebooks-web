"""Invoices list + detail views — Lane D cycle 2.

GET /invoices
    Renders templates/invoices/list.html (full page) or
    templates/invoices/_table.html (HTMX fragment when HX-Request header present).
    Query params: status, contact_id, date_from, date_to, limit (default 50), offset.
    Calls GET /api/v1/invoices with matching params.

GET /invoices/{id}
    Renders templates/invoices/detail.html.
